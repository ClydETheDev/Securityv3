...
client.on('ready', () => {
   var arrayOfStatus = [
        ...
        `.help | OnWard`,//change this with your status
...
.addField(`A User Just Landed In this server!!`, `Welcome To the Server ${member} I hope You enjoy it here`)
.addField("Server Member Count -", `${member.guild.memberCount}`)
.setColor(`RANDOM`)
channel1.send(embed);
